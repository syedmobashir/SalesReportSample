...
public:
	...
	BOOL GetDegradeHigh();
	void SetDegradeHigh(BOOL bNewValue);
	CPointSeries GetHighMarker();
	long GetDegradeInterval();
	void SetDegradeInterval(long nNewValue);
	double GetDownStep();
	void SetDownStep(double newValue);
};
