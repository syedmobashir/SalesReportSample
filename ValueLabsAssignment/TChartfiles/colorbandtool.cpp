...
BOOL CColorBandTool::GetAllowDrag()
{
	BOOL result;
...
void CColorBandTool::SetAllowDrag(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CColorBandTool::GetNoLimitDrag()
{
	BOOL result;
...
void CColorBandTool::SetNoLimitDrag(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CColorLineTool CColorBandTool::GetStartLine()
{
	LPDISPATCH pDispatch;
...
CColorLineTool CColorBandTool::GetEndLine()
{
	LPDISPATCH pDispatch;
