...
long CBubble3DSeries::AddPalette(double Value, unsigned long Color)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_I4;
...
unsigned long CBubble3DSeries::GetStartColor()
{
...
void CBubble3DSeries::SetStartColor(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
unsigned long CBubble3DSeries::GetEndColor()
{
	unsigned long result;
...
void CBubble3DSeries::SetEndColor(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CBubble3DSeries::GetPaletteSteps()
{
	long result;
...
void CBubble3DSeries::SetPaletteSteps(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CBubble3DSeries::GetUsePalette()
{
	BOOL result;
...
void CBubble3DSeries::SetUsePalette(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CBubble3DSeries::GetUseColorRange()
{
	BOOL result;
...
void CBubble3DSeries::SetUseColorRange(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CBubble3DSeries::ClearPalette()
{
	InvokeHelper(0x12, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CBubble3DSeries::CreateDefaultPalette(long NumSteps)
{
	static BYTE parms[] =
		VTS_I4;
...
unsigned long CBubble3DSeries::GetSurfacePaletteColor(double Y)
{
	unsigned long result;
	static BYTE parms[] =
		VTS_R8;
...
unsigned long CBubble3DSeries::GetMidColor()
{
	unsigned long result;
...
void CBubble3DSeries::SetMidColor(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBubble3DSeries::CreateRangePalette()
{
	InvokeHelper(0x22, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long CBubble3DSeries::GetPaletteStyle()
{
	long result;
...
void CBubble3DSeries::SetPaletteStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CBubble3DSeries::GetUsePaletteMin()
{
	BOOL result;
...
void CBubble3DSeries::SetUsePaletteMin(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double CBubble3DSeries::GetPaletteMin()
{
	double result;
...
void CBubble3DSeries::SetPaletteMin(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CBubble3DSeries::GetPaletteStep()
{
	double result;
...
void CBubble3DSeries::SetPaletteStep(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void CBubble3DSeries::InvertPalette()
{
	InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CBubble3DSeries::AddCustomPalette(const VARIANT& colorArray)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
long CBubble3DSeries::GetLegendEvery()
{
	long result;
...
void CBubble3DSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CBubble3DSeries::CountLegendItems()
{
	long result;
...
void CBubble3DSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CBubble3DSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
