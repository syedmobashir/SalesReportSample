...
long CCanvas::ColorAlpha(unsigned long AColor)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
unsigned long CCanvas::ColorFrom(unsigned long AColor, long Alpha)
{
	unsigned long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
void CCanvas::RoundRectWithZ(long Left, long Top, long Right, long Bottom, long X, long Y, long Z)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0xe3, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Left, Top, Right, Bottom, X, Y, Z);
}

LPDISPATCH CCanvas::CreatePath()
{
	LPDISPATCH result;
	InvokeHelper(0xe4, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
	return result;
}

long CCanvas::GetStretchDrawQuality()
{
	long result;
...
void CCanvas::SetStretchDrawQuality(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CCanvas::ClipCube(long Left, long Top, long Right, long Bottom, long MinZ, long MaxZ)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0xe6, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Left, Top, Right, Bottom, MinZ, MaxZ);
}

CPointArray CCanvas::CubeHull(long Left, long Top, long Right, long Bottom, long MinZ, long MaxZ)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4;
