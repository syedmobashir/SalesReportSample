...
CSeriesPointerItems CAreaSeries::GetPointer()
{
...
void CAreaSeries::SetSmoothed(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CAreaSeries::GetClickTolerance()
{
	long result;
...
void CAreaSeries::SetClickTolerance(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CAreaSeries::SetDrawStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CAreaSeries::GetInflateMargins()
{
	BOOL result;
...
void CAreaSeries::SetInflateMargins(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CAreaSeries::GetPointerBehind()
{
	BOOL result;
...
void CAreaSeries::SetPointerBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
