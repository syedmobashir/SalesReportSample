...
void CAspect::SetFontZoom(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CAspect::GetCanvasZoomText()
{
	long result;
...
void CAspect::SetCanvasZoomText(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
