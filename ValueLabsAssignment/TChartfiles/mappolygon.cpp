...
BOOL CMapPolygon::GetTransparent()
{
	BOOL result;
...
void CMapPolygon::SetTransparent(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CPolygonSeries CMapPolygon::GetPoints()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xd0, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPolygonSeries(pDispatch);
}

CString CMapPolygon::GetCode()
{
	CString result;
...
void CMapPolygon::SetCode(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
double CMapPolygon::GetSize()
{
	double result;
	InvokeHelper(0xd2, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
	return result;
}

void CMapPolygon::SetSize(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CBackImage CMapPolygon::GetPicture()
{
	LPDISPATCH pDispatch;
...
CTeePoint2D CMapPolygon::Centroid()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xd4, DISPATCH_METHOD, VT_DISPATCH, (void*)&pDispatch, NULL);
