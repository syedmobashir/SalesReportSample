...
public:
	...
	LPDISPATCH CreatePath();
	long GetStretchDrawQuality();
	void SetStretchDrawQuality(long nNewValue);
	void ClipCube(long Left, long Top, long Right, long Bottom, long MinZ, long MaxZ);
	CPointArray CubeHull(long Left, long Top, long Right, long Bottom, long MinZ, long MaxZ);
	BOOL GetIsAvailable();
};
