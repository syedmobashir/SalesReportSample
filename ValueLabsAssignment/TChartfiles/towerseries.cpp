...
void CTowerSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
long CTowerSeries::GetLegendEvery()
{
	long result;
...
void CTowerSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CTowerSeries::CountLegendItems()
{
	long result;
...
void CTowerSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CTowerSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
long CTowerSeries::GetStacked()
{
	long result;
	InvokeHelper(0x201, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
	return result;
}

void CTowerSeries::SetStacked(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
