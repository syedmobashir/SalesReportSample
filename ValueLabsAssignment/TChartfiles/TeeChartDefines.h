...
// EClockGaugeStyle
const unsigned long cgsDecimal = 0;
const unsigned long cgsRoman = 1;
...
const unsigned long scActivityGauge = 74;
const unsigned long scEqualizerSeries = 75;
const unsigned long scClockGauge = 76;
